...
class CI_Email {
	...
	var	$smtp_host		= "mail.digitrainee.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "admin@digitrainee.com";		// SMTP Username
	var	$smtp_pass		= "adminp45s";		// SMTP Password
	...
	var	$charset		= "text";	// Default char set: iso-8859-1 or us-ascii
